...
\input{./graphics/line-attribution}
...
\chapter{使用SAC函数库}
\label{chap:sac-libs}
\input{./sac-libs/intro-to-libs}
\input{./sac-libs/call-libsacio}
\input{./sac-libs/call-libsac}

\chapter{SAC I/O升级版}
\label{chap:sac-custom-io}

\chapter{SAC相关工具}
\input{./sac-tools/saclst}
\input{./sac-tools/sgftops}
\input{./sac-tools/sgftoeps}
\input{./sac-tools/sgftox}
...
\input{./commands/readdb}	%%%%
\input{./commands/readerr}
\input{./commands/readgse}	%%%%
\input{./commands/readhdr}
\input{./commands/readsdd}	%%%%
\input{./commands/readsp}
\input{./commands/readsuds}	%%%%
...
\input{./commands/writegse}	%%%%
\input{./commands/writehdr}
\input{./commands/writesdd}	%%%%
