...
\newpagestyle{main}{
    ...
    {第\thechapter章\quad\chaptertitle}{}{$\cdot$~\thepage~$\cdot$}
    \setfoot{}{}{}\headrule
}
...
\setdescription{itemsep=0pt,partopsep=0pt,parsep=\parskip,topsep=0pt,itemindent=0pt}
